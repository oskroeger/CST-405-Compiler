...
typedef enum { 
    ...
    NodeType_VarDecl, 
    NodeType_ParamList,       // Added for function parameters
    NodeType_Param,           // Added for function parameters
    NodeType_IntExpr,
    NodeType_FloatExpr,
    NodeType_SimpleID,
    NodeType_Expr, 
...
typedef struct ASTNode {
    ...
    union {
        ...
        struct {
            ...
            struct ASTNode* ParamList;  // Added for function definitions
            //struct ASTNode* varDeclList;
            //struct ASTNode* stmtList;
        ...
        struct {
            //struct ASTNode* expr;
            struct ASTNode* stmtList;
            struct ASTNode* varDeclList;  // Added for function definitions
        } block;
