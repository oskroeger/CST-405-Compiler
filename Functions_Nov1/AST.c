...
const char* nodeTypeToString(NodeType type) {
    switch (type) {
        ...
        case NodeType_Param: return "Parameter";
...
void traverseAST(ASTNode* node, int level) {
    ...
    switch (node->type) {
        ...
        case NodeType_FunctionDef:
            ...
            traverseAST(node->functionDef.block, level + 1);
            traverseAST(node->functionDef.ParamList, level + 1);
        ...
        case NodeType_Block:
            printf("\n");
            traverseAST(node->block.varDeclList, level + 1);
        ...
        case NodeType_ParamList:
            ...
            break;
        case NodeType_Param:
            printf(": %s %s\n", node->Param.varType, node->Param.varName);
            break;
        default:
...
void freeAST(ASTNode* node) {
    ...
    switch (node->type) {
        ...
        case NodeType_FunctionDef:
            ...
            freeAST(node->functionDef.block);
        ...
        case NodeType_Block:
            ...
            freeAST(node->block.varDeclList);
            break;
    }
